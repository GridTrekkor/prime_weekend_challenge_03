...
Inside the JSON file, you will have one object ({ }), inside that object you will have sub objects. One for each person in your cohort. So 19 sub objects. Inside those sub objects, assign three keys. One for their name, one for  [each description](https://docs.google.com/a/primeacademy.io/spreadsheets/d/13-Q-FIcs73l_SruQkC2WqDWV4_E62lyzTaKbrh9ELsQ/edit?usp=sharing) of that person, and finally one key for a [shout out for that person ](https://docs.google.com/a/primeacademy.io/spreadsheets/d/1wKVcbWEvPhcExhXXQrp8nz1yiumeQBNWXhTZvsd9V1I/edit?usp=sharing) (as taken from the daily feedback form. Fill that out more if you have let it slip ;) )
